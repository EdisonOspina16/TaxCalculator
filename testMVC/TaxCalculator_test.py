...
import model.InputOutputFunctions 
...
class TestTaxCalculator(unittest.TestCase):
    ...
    def test_extraordinary_tax_calculation_1(self):
        ...
        expected_result = 2375000000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)

    def test_extraordinary_tax_calculation_2(self):
        income = 1_000_000_000  # High income
        deductions = 0  # No deductions
        expected_result = 250000000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_extraordinary_tax_calculation_6(self):
        ...
        expected_result = 62500000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_normal_tax_calculation_1(self):
        ...
        expected_result = 22500000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_normal_tax_calculation_2(self):
        ...
        expected_result = 17500000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_normal_tax_calculation_3(self):
        ...
        expected_result = 10000000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_normal_tax_calculation_4(self):
        ...
        expected_result = 5000000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_normal_tax_calculation_5(self):
        ...
        expected_result = 3250000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_normal_tax_calculation_6(self):
        ...
        expected_result = 1125000.0  # Expected tax
        result = model.InputOutputFunctions.calculate_tax_value(income, deductions)
        self.assertEqual(result, expected_result)
    ...
    def test_error_negative_income(self):
        ...
        with self.assertRaises(ValueError):
            model.InputOutputFunctions.calculate_tax_value(income, deductions)
...
class TestUserFunctions(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        controller.Database.create_tables()

    def test_insert_user(self):
        """Prueba que un usuario se inserta correctamente."""
        user_id = controller.Database.insert_user(self.test_username, self.test_email)
    ...
    def test_get_user_by_email_found(self):
        ...
        user = controller.Database.get_user_by_email(self.test_email)
    ...
    def test_get_user_by_email_not_found(self):
        ...
        user = controller.Database.get_user_by_email("non_existent_user@example.com")
    ...
    def test_update_user_email(self):
        ...
        user_id = controller.Database.insert_user(self.test_username, self.test_email)
        controller.Database.update_user_email(user_id, self.updated_email)

        user = controller.Database.get_user_by_email(self.updated_email)
    ...
    def test_delete_user(self):
        ...
        user_id = controller.Database.insert_user(self.test_username, self.test_email)
        controller.Database.delete_user(user_id)
    ...
    def test_get_user_by_id(self):
        ...
        user_id = controller.Database.insert_user(self.test_username, self.test_email)
        user = controller.Database.get_user_by_id(user_id)
        self.assertIsNotNone(user, "Se esperaba que se encontrara un usuario.")
        self.assertEqual(user[1], self.test_username, "El nombre del usuario no coincide.")
    ...
    def test_get_user_calculations(self):
        ...
        user_id = controller.Database.insert_user(self.test_username, self.test_email)
        controller.Database.insert_calculation(user_id, 50000, 5000, 5000, 45000)
        calculations = controller.database.get_user_calculations(user_id)
